...
export default function RootLayout({
  ...
  return (
    <html lang="fr" className="dark">
      ...
      <body className={cn("font-body bg-background-light dark:bg-background-dark text-foreground antialiased transition-colors duration-200 selection:bg-primary/30")}>
        {children}
        <Toaster />
      </body>
    </html>
