...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="dark">
      ...
      <body className={cn("font-body bg-background-light dark:bg-background-dark text-foreground antialiased transition-colors duration-200 selection:bg-primary selection:text-white")}>
        {children}
        <Toaster />
      </body>
    </html>
