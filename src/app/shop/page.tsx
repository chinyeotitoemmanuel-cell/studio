...
export default function ShopPage() {
  const trendingProducts = [
    {
      name: "T-shirt Le Voyage de Kofi",
      price: "25.00€",
      ...
      alt: "T-shirt noir avec un graphisme doré stylisé d'un personnage de guerrier africain",
      tag: "POPULAIRE",
      tagColor: "bg-red-500",
    },
    {
      name: "Affiche Épique Sundiata",
      price: "15.00€",
      ...
      alt: "Grande affiche aux couleurs vives représentant un paysage urbain africain futuriste",
    },
    {
      name: "Tasse Totem Anansi",
      price: "12.00€",
      ...
      alt: "Tasse en céramique avec des motifs géométriques traditionnels en noir et orange",
    },
    {
      name: "Sweat à Capuche Zèbre",
      price: "45.00€",
      ...
      alt: "Sweat à capuche avec motif zébré sur les manches et logo sur la poitrine",
    },
  ];

  const freshDrops = [
    { name: "Tote Bag Lagos Vibes", price: "18.00€", image: "https://lh3.googleusercontent.com/aida-public/AB6AXuBQdngGE6zUSdKf2EKrFU-Cf8nFlDk-2xUpiuB7JtLQLpxPDF3cEV9pc7HMxjgi7ng4yWSPuHQ-rTKe2Cn_KdDoUIN90MEZ-CeC1-kb1yf4OljpLUc-4sePOCk6_o8hX3ST6QSm9Ox7sQf_G3GdjgyxWYUrz8nFKdvcwYq8BNX3pN30CDi20d_8UFOOHk0ds5Np-zvIt7hvig5wwOrzmBjPDlD_TbyCFGZqYfcTQeyJvdgcABYyaAhCshlHJmePuTWWkA3xwVvrBY6t", alt: "Sac fourre-tout avec un dessin au trait minimaliste" },
    { name: "Coque Motif 13", price: "22.00€", image: "https://lh3.googleusercontent.com/aida-public/AB6AXuA262FNLIjqP0APjsERu8xYmXJu-aLSWCFhPAJDd3Ke-m8XnZlI7_o51b8LME3y7i-PfYJvgeiL3x2qMnnBzFhGxIe35SX2LNv4cm_TgI-6AjfzpFExGGaOyyDfuhy4wolF8RXSxtaq7Wsa35-AYDnZf7Osz5mfsl2gUHN_9yLk2N3I_zwIO7XGm6fPvJFbiZEX9plWD8aZoqBBCGtpJEDkcoi0GRXiLN5-vT0fODIIBL5TqJYgJBCBPwwh0FXH12qJMENq5cyZ0Tui", alt: "Coque de téléphone avec motif géométrique coloré" },
    { name: "Journal du Conteur", price: "14.00€", image: "https://lh3.googleusercontent.com/aida-public/AB6AXuDVBhLRnql3NgehjFcUJSDhAF2Zhbf8VwuWsgCjg1WoqZqEvLUkyZh09SRfv84y8OiP7qnW3ooeW3ztHgv0Yi0lpabD0XsJc3t_CCfeOCai1oT5S1PeMQ0L8gJ6OL-z3Ef1ZBViky3XIjl4LriRMtknczor4VwUyWM1liMtzRBo6a-wHCQbV0ZUliJl3Ra_iBq3FGYtAErFAKQ4tduWTsBkA56O0JRdSxt547z4kukqX_oWUJp6mamQiymPw596wM3yVfH_nQQgD5YR", alt: "Carnet avec couverture d'art africain" },
    { name: "Casquette AfriStory", price: "28.00€", image: "https://lh3.googleusercontent.com/aida-public/AB6AXuA_gdDjp7ZE6Vx1Sn-Vj1-PTu5pmubfWWMeDRgVeHFneaRUMsAoXAidDNme6w98MFskg1Vg78W85s27gekQ4Ibo1rkziVcZGL7QjzKg9Nd-tmKjhCA8Q17hbKDfHje2_ndwvkQbgmTVa8_5DA6erCYtGolEJqqWf_2sEshoJIysuSUWvn2YIRU60HaXXxmqoIAofat-c219XVnUzteO4Z2rbMKxQ9udWrFQY1GJJmsxaItfOPB4M9eSDsiaZ7n9zcjccV4cliqNqQe-", alt: "Casquette snapback avec logo brodé" },
    { name: "Chaussettes Esprit", price: "10.00€", image: "https://lh3.googleusercontent.com/aida-public/AB6AXuCCgCyNJwXdpF-b7G76teuw9_cox1Ti-vcmDcFafTrzyj-erOcO4KIOzp8S1XGbbjNQvbyAO-ewo7HzF9nNVxWYqjKTAJxrYmLM-LOWU1a1hQSa-23zg5FYlVOFNVa-At2vPsTkx4f6TbrwQzInsudMvlhftxtYUYicMCCLRYr21wdncDm6dwDV7sOhTvotLxHqVtzg68_so2wmszpCTCaLp842G4oTcgIq1WPC1Ua8mv8beV9iWZ4T23hI5tD709L8HdBeiUvWtjj6", alt: "Paire de chaussettes à motifs colorés", className: "md:hidden lg:flex" },
  ];

  const categories = ["Tous les articles", "Vêtements", "Impressions d'art", "Accessoires", "Éditions limitées", "Papeterie"];
        ...
        <div className="flex w-full max-w-[1200px] flex-1 flex-col px-4 md:px-10">
          <div className="@container mb-10">
            <div
              ...
              data-alt="Arrière-plan de motif africain abstrait et vibrant dans des tons orange chaud et marron foncé"
            >
              <div className="max-w-2xl flex-col gap-2 text-left">
                ...
                <h1 className="text-4xl font-black leading-tight tracking-[-0.033em] text-white shadow-sm md:text-6xl">
                  Portez les histoires que vous aimez
                </h1>
                <h2 className="mt-2 max-w-lg text-sm font-normal leading-normal text-white/90 md:text-lg md:font-medium">
                  Produits dérivés officiels des meilleurs créateurs d'Afrique. Soutenez directement les artistes à chaque achat.
                </h2>
              </div>
          ...
          <div className="flex items-center justify-between pb-4 pt-2">
            <h2 className="text-2xl font-bold leading-tight text-white md:text-3xl">Tendances actuelles</h2>
          ...
          <div className="mb-16 overflow-hidden rounded-2xl bg-shop-surface-dark">
            <div className="flex flex-col md:flex-row">
              <div className="relative h-64 w-full md:h-auto md:w-1/2">
                <Image src="https://lh3.googleusercontent.com/aida-public/AB6AXuBfSl8XQaLN5ZwGhlYKt_cwJRHoR5mb83I5YaNp17OJ_fxYzf4chfstRydNyKKGF4_4SY94pT-HS7wKU1z1UDt7Ovtnh4_6yhmg1i-kLN6BweyEqrRl4EL3VZnt9y9pUWuGLcv6ItUlNvr9qskZGXq2fVagJkLVEDRrOeCqYZ331tkkOgez-g3Lc-tBpXmGYH_UP2XJBaA5WodX05Ag80KRU3UdMw9f6Jvtf4uGMFzDr8734nnZj683xMeikEqJpiuC9mUA1QT8fo7e" alt="Portrait d'un artiste numérique africain travaillant sur une tablette dans un studio coloré" fill sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="object-cover" />
              ...
              <div className="flex w-full flex-col justify-center p-8 md:w-1/2 md:p-12">
                <div className="mb-4 flex items-center gap-2">
                  ...
                  <span className="text-xs font-bold uppercase tracking-widest text-primary">Artiste en vedette</span>
                </div>
                <h2 className="mb-4 text-3xl font-black text-white md:text-4xl">Rencontrez Amara Diallo</h2>
                <p className="mb-6 leading-relaxed text-text-secondary">
                  La créatrice du roman graphique primé "Les Sables du Temps". La collection exclusive de produits dérivés d'Amara capture l'esprit vibrant de l'ancien Mali avec une touche futuriste.
                </p>
          ...
          <div className="flex items-center justify-between pb-4 pt-2">
            <h2 className="text-2xl font-bold leading-tight text-white md:text-3xl">Nouveautés</h2>
            ...
            <div className="grid grid-cols-1 gap-10 md:grid-cols-3">
              <div className="flex flex-col gap-4">
                <div className="flex items-center gap-2 text-white">
                  ...
                  <h2 className="text-lg font-bold text-white">Boutique AfriStory</h2>
                </div>
                <p className="text-sm text-text-secondary">Soutenir les créateurs africains en donnant vie à leurs histoires à travers des produits exclusifs.</p>
              </div>
              <div className="flex gap-12">
                <div className="flex flex-col gap-3">
                  <h4 className="text-sm font-bold text-white">Boutique</h4>
                  <Link href="#" className="text-sm text-text-secondary hover:text-primary">Nouveautés</Link>
                  <Link href="#" className="text-sm text-text-secondary hover:text-primary">Meilleures ventes</Link>
                  <Link href="#" className="text-sm text-text-secondary hover:text-primary">Artistes</Link>
                  <Link href="#" className="text-sm text-text-secondary hover:text-primary">Promotions</Link>
                </div>
                <div className="flex flex-col gap-3">
                  <h4 className="text-sm font-bold text-white">Support</h4>
                  <Link href="#" className="text-sm text-text-secondary hover:text-primary">Centre d'aide</Link>
                  <Link href="#" className="text-sm text-text-secondary hover:text-primary">Livraison</Link>
                  <Link href="#" className="text-sm text-text-secondary hover:text-primary">Retours</Link>
                  <Link href="#" className="text-sm text-text-secondary hover:text-primary">Guide des tailles</Link>
                </div>
              </div>
              <div className="flex flex-col gap-4">
                <h4 className="text-sm font-bold text-white">Restez informé</h4>
                <div className="flex gap-2">
                  <Input type="email" placeholder="Entrez votre email" className="w-full rounded-lg border-none bg-shop-surface-dark px-4 py-2 text-sm text-white placeholder:text-text-secondary/50 focus:ring-1 focus:ring-primary" />
                  <Button className="px-4 text-sm font-bold text-background-dark hover:bg-white">Rejoindre</Button>
                </div>
              </div>
            </div>
            <div className="mt-10 flex flex-col items-center justify-between gap-4 text-xs text-text-secondary md:flex-row">
              <p>© 2023 AfriStory. Tous droits réservés.</p>
